    ...
    for bs in batch_size:
        for lr in learning_rate:
            for ed in embedding_dim:
                ...
                mu_similar_triples = pd.read_csv(f"../data/data_new_KRAS/mu_similar_noKRAS.csv", header=None)
                ...
                for mode in range(0,1):
                    for fold in range(4,5):
                        train_set = pd.concat([train_set, mu_similar_triples,drug_similar_triples], axis=0)
