...
- `datasets/prediction_datasets` Contains all data for training IDDGCN and provides pre-trained weights in the `prediction_datasets/weights` subdirectory, which can be directly used for model evaluation.
