...
- `datasets/explanation_datasets` Contains the data needed to construct ground truth and train the interpretability models, as well as pre-constructed groundtruth and explanations generated by the interpretability models for evaluation.
## Run IDDGCN
